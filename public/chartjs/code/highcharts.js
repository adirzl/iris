...
(function(T, O) { "object" === typeof module && module.exports ? (O["default"] = O, module.exports = T.document ? O(T) : O) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function() { return O(T) }) : (T.Highcharts && T.Highcharts.error(16, !0), T.Highcharts = O(T)) })("undefined" !== typeof window ? window : this, function(T) {
    ...
    O(n, "Core/Utilities.js", [n["Core/Globals.js"]], function(f) {
        ...
        function S() { var b, c = arguments,
                e = {},
                d = function(b, c) { "object" !== typeof b && (b = {});
                    U(c, function(e, z) {!y(e, !0) || t(e) || p(e) ? b[z] = c[z] : b[z] = d(b[z] || {}, e) }); return b };!0 === c[0] && (e = c[1], c = Array.prototype.slice.call(c, 2)); var z = c.length; for (b = 0; b < z; b++) e = d(e, c[b]); return e }

        function y(b,
            c) { return !!b && "object" === typeof b && (!c || !E(b)) }

        function n(b, c, e) { var d;
            K(c) ? m(e) ? b.setAttribute(c, e) : b && b.getAttribute && ((d = b.getAttribute(c)) || "class" !== c || (d = b.getAttribute(c + "Name"))) : U(c, function(c, e) { b.setAttribute(e, c) }); return d }
        ...
        f.error = a;
        var L = function() {
            function b(b, c, e) { this.options = c;
                this.elem = b;
                this.prop = e }
            b.prototype.dSetter = function() {
                ...
                if (1 !== d && c && b)
                    if (c.length === b.length && 1 > d)
                        for (var z = 0; z < b.length; z++) { for (var w = c[z], g = b[z], k = [], h = 0; h < g.length; h++) { var P = w[h],
                                    l = g[h];
            ...
            b.prototype.update = function() { var b = this.elem,
                    c = this.prop,
                    e = this.now,
                    d = this.options.step; if (this[c + "Setter"]) this[c + "Setter"]();
            ...
            b.prototype.initPath = function(b, c, e) {
                function d(b, c) { for (; b.length < r;) { var e = b[0],
                            d = c[r - b.length];
                ...
                function z(b, c) {
                    for (; b.length < r;)
                        if (c = b[b.length /
                                k - 1].slice(), "C" === c[0] && (c[1] = c[5], c[2] = c[6]), h) { var e = b[b.length / k].slice();
                            b.splice(b.length / 2, 0, c, e) } else b.push(c)
                }
                var w = b.startX,
                    g = b.endX;
                c = c && c.slice();
                ...
                var h = b.isArea,
                    k = h ? 2 : 1;
                if (!c) return [e, e];
                if (w && g) { for (b = 0; b < w.length; b++)
                        if (w[b] === g[0]) { var P = b; break } else if (w[0] === g[g.length - w.length + b]) { P = b; var l = !0; break } else if (w[w.length - 1] === g[g.length - w.length + b]) { P = w.length - b; break } "undefined" === typeof P && (c = []) }
                if (c.length && I(P)) { var r = e.length + P * k;
        ...
        var p = f.isDOMElement = function(b) {
            ...
            u = f.erase = function(b, c) { for (var e = b.length; e--;)
        ...
        var h = f.splat = function(b) { return E(b) ? b : [b] },
            l = f.syncTimeout = function(b, c, e) { if (0 < c) return setTimeout(b, c, e);
                b.call(0, e); return -1 },
            k = f.clearTimeout = function(b) { m(b) && clearTimeout(b) },
            g = f.extend = function(b, c) { var e;
                b || (b = {}); for (e in c) b[e] = c[e]; return b };
        f.pick = G;
        var d = f.css = function(b, c) { f.isMS && !f.svg && c && "undefined" !== typeof c.opacity && (c.filter = "alpha(opacity=" + 100 * c.opacity + ")");
                g(b.style, c) },
            x = f.createElement = function(b, c, e, z, w) { b = H.createElement(b);
                c && g(b, c);
                w && d(b, { padding: "0", border: "none", margin: "0" });
                e && d(b, e);
                z && z.appendChild(b); return b },
            ...
            B = f.wrap = function(b, c, e) { var d = b[c];
                b[c] = function() { var b = Array.prototype.slice.call(arguments),
                        c = arguments,
                        z = this;
                    z.proceed = function() { d.apply(z, arguments.length ? arguments : c) };
                    b.unshift(d);
                    b = e.apply(this, b);
                    z.proceed = null; return b } },
            M = f.format = function(b, c, e) {
                var d = "{",
                    ...
                    P = e && e.time || f.time;
                for (e = e && e.numberFormatter || X; b;) { var l = b.indexOf(d); if (-1 === l) break; var r = b.slice(0, l); if (z) { r = r.split(":");
                        d = C(r.shift() || "", c); if (r.length && "number" === typeof d)
                            if (r = r.join(":"), g.test(r)) { var m = parseInt((r.match(h) || ["", "-1"])[1], 10);
                                null !== d && (d = e(d, m, k.decimalPoint, -1 < r.indexOf(",") ? k.thousandsSep : "")) } else d = P.dateFormat(r, d);
                        w.push(d) } else w.push(r);
                    b = b.slice(l + 1);
                    d = (z = !z) ? "}" : "{" }
                w.push(b);
                return w.join("")
            ...
            F = f.normalizeTickInterval = function(b, c, e, d, z) { var w = b;
                e = G(e, 1); var g = b / e;
                c || (c = z ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === d && (1 === e ? c = c.filter(function(b) { return 0 === b % 1 }) : .1 >= e && (c = [1 / e]))); for (d = 0; d < c.length && !(w = c[d], z && w * e >= b || !z && g <= (c[d] + (c[d + 1] || c[d])) / 2); d++); return w = P(w * e, -Math.round(Math.log(.001) / Math.LN10)) },
            ...
            z = f.destroyObjectProperties = function(b, c) { U(b, function(e, d) { e && e !== c && e.destroy && e.destroy();
                    delete b[d] }) },
            w = f.discardElement = function(b) { var c = f.garbageBin;
                c || (c = x("div"));
                b && c.appendChild(b);
                c.innerHTML = "" },
        ...
        var ba = f.getStyle = function(b, c, e) {
            ...
            ca = f.getDeferredAnimation = function(b, c, e) { var d = W(c),
                    z = 0,
                    w = 0;
                (e ? [e] : b.series).forEach(function(b) { b = W(b.options.animation);
                    z = c && m(c.defer) ? d.defer : Math.max(z, b.duration + b.defer);
                    w = Math.min(d.duration, b.duration) });
                b.renderer.forExport && (z = 0); return { defer: Math.max(0, z - w), duration: Math.min(z, w) } },
            ...
            function(b, c) { var e, d = b.length; for (e = 0; e < d; e++)
                    if (c(b[e], e)) return b[e] };
        f.keys = function(b) { a(32, !1, void 0, { "Highcharts.keys": "use Object.keys" }); return Object.keys(b) };
        var Q = f.offset = function(b) { var c = H.documentElement;
                b = b.parentElement || b.parentNode ? b.getBoundingClientRect() : { top: 0, left: 0 }; return { top: b.top + (v.pageYOffset || c.scrollTop) - (c.clientTop || 0), left: b.left + (v.pageXOffset || c.scrollLeft) - (c.clientLeft || 0) } },
        ...
        U({ map: "map", each: "forEach", grep: "filter", reduce: "reduce", some: "some" }, function(b, c) { f[c] = function(e) { var d;
                a(32, !1, void 0, (d = {}, d["Highcharts." + c] = "use Array." + b, d)); return Array.prototype[b].apply(e, [].slice.call(arguments, 1)) } });
        var ja = f.addEvent = function(b, c, e, d) {
            ...
            ha = f.removeEvent = function(b, c, e) {
                function d(c, e) { var d = b.removeEventListener || f.removeEventListenerPolyfill;
                    d && d.call(b, c, e, !1) }

                function z(e) { var z; if (b.nodeName) { if (c) { var w = {};
                            w[c] = !0 } else w = e;
                        U(w, function(b, c) { if (e[c])
                                for (z = e[c].length; z--;) d(c, e[c][z].fn) }) } }
                var w;
                ["protoEvents", "hcEvents"].forEach(function(g, h) { var k = (h = h ? b : b.prototype) && h[g];
            ...
            ea = f.fireEvent = function(b, c, e, d) {
                ...
                if (H.createEvent && (b.dispatchEvent || b.fireEvent)) {
                    ...
                    function(c, d) { void 0 === c && (c = []);
                        void 0 === d && (d = []); var w = 0,
                            g = 0,
                            h = c.length + d.length; for (z = 0; z < h; z++) !1 === (c[w] ? d[g] ? c[w].order <= d[g].order ? c[w++] : d[g++] : c[w++] : d[g++]).fn.call(b, e) && e.preventDefault() }(b.protoEvents && b.protoEvents[c], b.hcEvents && b.hcEvents[c]);
            ...
            ka = f.animate = function(b, c, e) {
                ...
                e.curAnim = S(c);
                U(c, function(h, k) { fa(b, k);
                    g = new L(b, e, k);
                    w = null; "d" === k && E(c.d) ? (g.paths = g.initPath(b, b.pathArray, c.d), g.toD = c.d, d = 0, w = 1) : b.attr ? d = b.attr(k) : (d = parseFloat(ba(b, k)) || 0, "opacity" !== k && (z = "px"));
                    w || (w = h);
            ...
            da, ma = f.uniqueKey = function() { var b = Math.random().toString(36).substring(2, 9) + "-",
                    c = 0; return function() { return "highcharts-" + (da ? "" : b) + c++ } }(),
        ...
        a = function() {
            ...
            a.prototype.init = function(f) {
                ...
                if ((this.input = f = a.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops) this.stops = f.stops.map(function(q) { return new a(q[1]) });
                    ...
                    if (f && f.charAt && "#" === f.charAt()) { var v = f.length;
            ...
            a.prototype.get = function(a) { var f = this.input,
                    H = this.rgba; if ("undefined" !== typeof this.stops) { var v = y(f);
                    v.stops = [].concat(v.stops);
                    this.stops.forEach(function(f, q) { v.stops[q] = [v.stops[q][0], f.get(a)] }) } else v = H && S(H[0]) ? "rgb" === a || !a && 1 === H[3] ? "rgb(" + H[0] + "," + H[1] + "," + H[2] + ")" : "a" === a ? H[3] : "rgba(" + H.join(",") + ")" : f; return v };
            ...
            a.prototype.tweenTo = function(a, f) { var H = this.rgba,
                    v = a.rgba;
                v.length && H && H.length ? (a = 1 !== v[3] || 1 !== H[3], f = (a ? "rgba(" : "rgb(") + Math.round(v[0] + (H[0] - v[0]) * (1 - f)) + "," + Math.round(v[1] + (H[1] - v[1]) * (1 - f)) + "," + Math.round(v[2] + (H[2] - v[2]) * (1 - f)) + (a ? "," + (v[3] + (H[3] - v[3]) * (1 - f)) : "") + ")") : f = a.input || "none"; return f };
    ...
    O(n, "Core/Renderer/SVG/SVGElement.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a, n) {
        ...
        "";
        n = function() {
            function F() { this.height = this.element = void 0;
                this.opacity = 1;
            ...
            F.prototype.alignSetter = function(e) { var c = { left: "start", center: "middle", right: "end" };
            ...
            F.prototype.attr = function(e, c, b, d) {
                ...
                if ("string" === typeof e && "undefined" !== typeof c) { var x = e;
                    e = {};
                    e[x] = c }
            ...
            F.prototype.complexColor = function(e, c, b) {
                ...
                h(this.renderer, "complexColor", { args: arguments }, function() {
                    ...
                    if (g) {
                        ...
                        else { k.id = M = R(); var z = p[Q] = d.createElement(g).attr(k).add(d.defs);
                            z.radAttr = m;
                            z.stops = [];
                            B.forEach(function(b) { 0 === b[1].indexOf("rgba") ? (w = f.parse(b[1]), t = w.get("rgb"), A = w.get("a")) : (t = b[1], A = 1);
            ...
            F.prototype.css = function(e) {
                ...
                if (g) {
                    ...
                    if (d.namespaceURI === this.SVG_NS) { var l = function(b, c) { return "-" + c.toLowerCase() };
                        r(e, function(b, c) {-1 === k.indexOf(c) && (w += c.replace(/([A-Z])/g, l) + ":" + b + ";") });
                        w && E(d, "style", w) } else t(d, e);
            ...
            F.prototype.destroy = function() {
                ...
                c.onclick = c.onmouseout = c.onmouseover = c.onmousemove = c.point =
                    null;
                B(e);
                if (e.clipPath && w) { var g = e.clipPath;
                ...
                if (e.stops) { for (w = 0; w < e.stops.length; w++) e.stops[w].destroy();
                    e.stops.length = 0;
                    e.stops = void 0 }
                e.safeRemoveChild(c);
                ...
                e.alignTo && u(b.alignedObjects,
                    e);
                r(e, function(b, c) { e[c] && e[c].parentGroup === e && e[c].destroy && e[c].destroy();
                    delete e[c] })
            };
            ...
            F.prototype.fadeOut = function(e) { var c = this;
            ...
            F.prototype.getBBox = function(e, c) {
                ...
                if (I(h)) { var B = h.toString(); - 1 === B.indexOf("<") && (B = B.replace(/[0-9]/g, "0"));
                    B += ["", c, p, this.textWidth, g && g.textOverflow, g && g.fontWeight].join() }
                B && !e && (b = l[B]);
                if (!b) {
                    if (x || d.forExport) { try { var t = this.fakeTS && function(b) {
                            ...
                            k(t) && t("") } catch (V) { "" } if (!b || 0 > b.width) b = { width: 0, height: 0 } } else b = this.htmlGetBBox();
                    d.isSVG &&
                    ...
                    if (B && 0 < b.height) { for (; 250 < r.length;) delete l[r.shift()];
                        l[B] || r.push(B);
                        l[B] = b }
                }
                return b
            ...
            F.prototype.init = function(e, c) { this.element = "span" === c ? p(c) : D.createElementNS(this.SVG_NS, c);
                this.renderer = e;
                h(this, "afterInit") };
            F.prototype.invert = function(e) { this.inverted = e;
            ...
            F.prototype.on = function(e, c) {
                ...
                G && "click" === e ? (w.ontouchstart = function(c) {
                    ...
                    d =
                        c.touches[0].clientY
                }, w.ontouchend = function(e) { b && 4 <= Math.sqrt(Math.pow(b - e.changedTouches[0].clientX, 2) + Math.pow(d - e.changedTouches[0].clientY, 2)) || c.call(w, e);
                    g = !0;
                    e.preventDefault() }, w.onclick = function(b) { g || c.call(w, b) }) : w["on" + e] = c;
                return this
            };
            F.prototype.opacitySetter = function(e, c, b) { this[c] = e;
                b.setAttribute(c, e) };
            ...
            F.prototype.safeRemoveChild = function(e) { var c = e.parentNode;
                c && c.removeChild(e) };
            F.prototype.setRadialReference = function(e) { var c = this.element.gradient && this.renderer.gradients[this.element.gradient];
                this.element.radialReference = e;
                c && c.radAttr && c.animate(this.renderer.getRadialAttr(e, c.radAttr)); return this };
            ...
            F.prototype.symbolAttr = function(e) { var c = this; "x y r start end width height innerR anchorX anchorY clockwise".split(" ").forEach(function(b) { c[b] = A(e[b], c[b]) });
            ...
            F.prototype.toFront = function() { var e = this.element;
                e.parentNode.appendChild(e); return this };
            ...
            F.prototype.visibilitySetter = function(e, c, b) { "inherit" === e ? b.removeAttribute(c) : this[c] !== e && b.setAttribute(c, e);
                this[c] = e };
            ...
            F.prototype.zIndexSetter = function(e, c) {
                ...
                if (l) {
                    ...
                    c = g.childNodes; for (r = c.length - 1; 0 <= r && !h; r--) { d = c[r];
                        l = d.getAttribute("data-z-index"); var m = !I(l); if (d !== k)
        ...
        n.prototype.matrixSetter = n.prototype.rotationOriginXSetter = n.prototype.rotationOriginYSetter = n.prototype.rotationSetter = n.prototype.scaleXSetter = n.prototype.scaleYSetter = n.prototype.translateXSetter = n.prototype.translateYSetter = n.prototype.verticalAlignSetter = function(d, e) { this[e] = d;
            this.doTransform = !0 };
        a.SVGElement = n;
        return a.SVGElement
    });
    O(n, "Core/Renderer/SVG/SVGLabel.js", [n["Core/Renderer/SVG/SVGElement.js"],
        ...
        var n = this && this.__extends || function() { var a = function(f, L) { a = Object.setPrototypeOf || { __proto__: [] }
                    instanceof Array && function(a, f) { a.__proto__ = f } || function(a, f) { for (var q in f) f.hasOwnProperty(q) && (a[q] = f[q]) }; return a(f, L) }; return function(f, L) {
        ...
        return function(a) {
            function v(f, q, H, E, p, t, I,
                ...
                l.anchorY = I;
                l.baseline = m;
                l.className = h; "button" !== h && l.addClass("highcharts-label");
                h && l.addClass("highcharts-" + h);
                l.text = f.text("", 0, 0, u).attr({ zIndex: 1 }); if ("string" === typeof p) { var k = /^url\((.*?)\)$/.test(p); if (l.renderer.symbols[p] || k) l.symbolKey = p }
                l.bBox = v.emptyBBox;
                l.padding = 3;
                l.paddingLeft = 0;
                l.baselineOffset = 0;
            ...
            v.prototype.destroy = function() { J(this.element, "mouseenter");
                J(this.element, "mouseleave");
                this.text && this.text.destroy();
                this.box && (this.box = this.box.destroy());
                f.prototype.destroy.call(this) };
            v.prototype.fillSetter = function(a, f) { a && (this.needsBox = !0);
                this.fill = a;
                this.boxAttr(f, a) };
            v.prototype.getBBox =
                function() { var a = this.bBox,
                        f = this.padding; return { width: a.width + 2 * f, height: a.height + 2 * f, x: a.x - f, y: a.y - f } };
            ...
            v.prototype.onAdd = function() { var a = this.textStr;
                this.text.add(this);
            ...
            v.prototype.strokeSetter = function(a, f) { this.stroke = a;
                this.boxAttr(f, a) };
            v.prototype["stroke-widthSetter"] = function(a, f) { a && (this.needsBox = !0);
                this["stroke-width"] = a;
                this.boxAttr(f, a) };
            v.prototype["text-alignSetter"] = function(a) { this.textAlign = a };
            v.prototype.textSetter =
                function(a) { "undefined" !== typeof a && this.text.attr({ text: a });
                    this.updateBoxSize();
            ...
            v.prototype.updateTextPadding =
                function() { var a = this.text,
                        f = this.baseline ? 0 : this.baselineOffset,
                        v = this.paddingLeft + this.padding;
                    y(this.widthSetting) && this.bBox && ("center" === this.textAlign || "right" === this.textAlign) && (v += { center: .5, right: 1 }[this.textAlign] * (this.widthSetting - this.bBox.width)); if (v !== a.x || f !== a.y) a.attr("x", v), a.hasBoxWidthChanged && (this.bBox = a.getBBox(!0), this.updateBoxSize()), "undefined" !== typeof f && a.attr("y", f);
                    a.x = v;
                    a.y = f };
            ...
            v.prototype.ySetter = function(a) { this.ySetting = this.y = Math.round(a);
    ...
    O(n, "Core/Renderer/SVG/SVGRenderer.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Renderer/SVG/SVGElement.js"], n["Core/Renderer/SVG/SVGLabel.js"], n["Core/Utilities.js"]], function(f, a, n, y, D) {
        ...
        var B = a.svg,
            ...
            F = a.win,
            e = function() {
                function c(b, c, e, d, g, k, h) { this.width = this.url = this.style = this.isSVG = this.imgCount = this.height = this.gradients = this.globalAnimation = this.defs = this.chartIndex = this.cacheKeys = this.cache = this.boxWrapper = this.box = this.alignedObjects = void 0;
                ...
                c.prototype.init = function(b, c, e, d, g, k, h) {
                    ...
                    this.setSize(c, e, !1);
                    var z;
                    r && b.getBoundingClientRect && (c = function() { H(b, { left: 0, top: 0 });
                        z = b.getBoundingClientRect();
                        H(b, { left: Math.ceil(z.left) - z.left + "px", top: Math.ceil(z.top) - z.top + "px" }) }, c(), this.unSubPixelFix = G(F, "resize", c))
                };
                ...
                c.prototype.createElement = function(b) { var c = new this.Element;
                ...
                c.prototype.truncate = function(b, c, e, d, g, k, h) {
                    var w = this,
                        ...
                        B = function(z, k) { k = k || z; if ("undefined" === typeof p[k])
                    ...
                    if (a = g + A > k) { for (; r <= m;) P = Math.ceil((r + m) / 2), d && (l = h(d, P)), A = B(P, l && l.length - 1), r === m ? r = m + 1 : A > k ? m = P - 1 : r = P;
                ...
                c.prototype.buildText = function(b) {
                    ...
                    var v = function(b) {
                        ...
                        n = function(b, c) { var e = b.indexOf("<");
                            b = b.substring(e, b.indexOf(">") - e);
                            e = b.indexOf(c + "="); if (-1 !== e && (e = e + c.length + 1, c = b.charAt(e), '"' === c || "'" === c)) return b = b.substring(e + 1), b.substring(0, b.indexOf(c)) },
                        K = /<br.*?>/g;
                        ...
                        k || Q || f || A || -1 !== g.indexOf(" ") && (!F ||
                            ...
                            h.forEach(function(g) {
                                if ("" !== g || 1 === h.length) {
                                    ...
                                    if ((a = n(g, "href")) && !d && -1 === a.split(":")[0].toLowerCase().indexOf("javascript")) { var t = x.createElementNS(e.SVG_NS, "a");
                                        C(t, "href", a);
                ...
                c.prototype.getContrast = function(b) { b = f.parse(b).rgba;
                    b[0] *= 1;
                    b[1] *= 1.2;
                ...
                c.prototype.button = function(b,
                    ...
                    w.setState = function(b) { 1 !== b && (w.state = z = b);
                ...
                c.prototype.crispLine = function(b, c, e) { void 0 === e && (e = "round"); var d = b[0],
                        g = b[1];
                    d[1] === g[1] && (d[1] = g[1] = Math[e](d[1]) - c % 2 / 2);
                    d[2] === g[2] && (d[2] = g[2] = Math[e](d[2]) + c % 2 / 2); return b };
                c.prototype.path = function(b) { var c = this.styledMode ? {} : { fill: "none" };
                    K(b) ? c.d = b : p(b) && q(c, b); return this.createElement("path").attr(c) };
                ...
                c.prototype.arc = function(b, c, e, d, g, k) { p(b) ? (d = b, c = d.y, e = d.r, b = d.x) : d = { innerR: d, start: g, end: k };
                ...
                c.prototype.rect = function(b, c, e, d, g, k) {
                    ...
                    g && (b.r = g);
                    w.rSetter = function(b, c, e) { w.r = b;
                        C(e, { rx: b, ry: b }) };
                    w.rGetter = function() { return w.r };
                    return w.attr(b)
                };
                c.prototype.setSize = function(b, c, e) { var d = this.alignedObjects,
                        g = d.length;
                    this.width = b;
                    this.height = c; for (this.boxWrapper.animate({ width: b, height: c }, { step: function() { this.attr({ viewBox: "0 0 " + this.attr("width") + " " + this.attr("height") }) }, duration: m(e, !0) ? void 0 : 0 }); g--;) d[g].align() };
                ...
                c.prototype.symbol = function(b, c, e, d, k, h) {
                    var w = this,
                        ...
                        P = r && this.symbols[r],
                        t;
                    if (P) { "number" === typeof c && (t = P.call(this.symbols, Math.round(c || 0), Math.round(e || 0), d || 0, k || 0, h)); var a = this.path(t);
                ...
                c.prototype.clipRect = function(b, c, e, d) { var g = k() + "-",
                ...
                c.prototype.text = function(b, c,
                    ...
                    d || (b.xSetter = function(b, c, e) { var d = e.getElementsByTagName("tspan"),
                            g = e.getAttribute(c),
                            k; for (k = 0; k < d.length; k++) { var w = d[k];
                            w.getAttribute(c) === g && w.setAttribute(c, b) }
                        e.setAttribute(c, b) }); return b };
                ...
                c.prototype.rotCorr = function(b, c, e) { var g = b;
                    c && e && (g = Math.max(g * Math.cos(c * d), 4)); return { x: -b / 3 * Math.sin(c * d), y: g } };
        ...
        e.prototype.symbols = {
            ...
            triangle: function(c, b, e, d) { return [
                    ["M", c + e / 2, b],
                    ["L", c + e, b + d],
                    ["L", c, b + d],
                    ["Z"]
                ] },
            "triangle-down": function(c, b, e, d) { return [
                    ["M", c, b],
                    ["L", c + e, b],
                    ["L", c + e / 2, b + d],
                    ["Z"]
                ] },
            diamond: function(c, b, e, d) { return [
                    ["M", c + e / 2, b],
                    ["L", c + e, b + d / 2],
                    ["L", c + e / 2, b + d],
                    ["L", c, b + d / 2],
        ...
        H(n.prototype, {
            ...
            html: function(p, f, u) {
                var m = this.createElement("span"),
                    ...
                    k = l.isSVG,
                    g = function(d, g) {
                        ["opacity", "visibility"].forEach(function(k) { d[k + "Setter"] = function(h, l, r) { var m = d.div ? d.div.style : g;
                                a.prototype[k + "Setter"].call(this, h, l, r);
                                m && (m[l] = h) } });
                        d.addedSetters = !0 };
                m.textSetter = function(d) { d !== h.innerHTML && (delete this.bBox, delete this.oldTextWidth);
                    this.textStr = d;
                    h.innerHTML = v(d, "");
                    m.doTransform = !0 };
                k && g(m, m.element.style);
                m.xSetter = m.ySetter = m.alignSetter =
                    m.rotationSetter = function(d, g) { "align" === g ? m.alignValue = m.textAlign = d : m[g] = d;
                        m.doTransform = !0 };
                    ...
                    if (this.parentGroup = d) {
                        ...
                        if (!a) {
                            ...
                            r.reverse().forEach(function(d) {
                                function h(g, e) { d[e] = g; "translateX" === e ? x.left = g + "px" : x.top = g + "px";
                                    d.doTransform = !0 }
                                ...
                                var x = a.style;
                                H(d, {
                                    classSetter: function(d) { return function(e) { this.element.setAttribute("class", e);
                                            d.className = e } }(a),
                                    on: function() {
                                        r[0].div &&
    ...
    O(n, "Core/Axis/Tick.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        a = function() {
            ...
            a.prototype.getPosition = function(a, t, f, u) { var m = this.axis,
                    h = m.chart,
                ...
                a.y = n(a.y, -1E5, 1E5);
                J(this, "afterGetPosition", { pos: a }); return a };
            ...
            a.prototype.getMarkPath = function(a, t, f, u, m, h) { return h.crispLine([
                    ["M", a, t],
                    ["L", a + (m ? 0 : -f), t + (m ? f : 0)]
                ], u) };
            ...
            a.prototype.render = function(a, t, f) { var p = this.axis,
                    m = p.horiz,
                    h = this.pos,
            ...
            a.prototype.replaceMovedLabel = function() { var a = this.label,
                    f = this.axis,
                    q = f.reversed; if (a && !this.isNew) { var u = f.horiz ? q ? f.left : f.width + f.left : a.xy.x;
    ...
    O(n, "Core/Time.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        a = function() {
            function a(a) { this.options = {};
                ...
                this.update(a) }
            a.prototype.get = function(a, f) { if (this.variableTimezone || this.timezoneOffset) { var p = f.getTime(),
                        t = p - this.getTimezoneOffset(f);
                    f.setTime(t);
                    a = f["getUTC" + a]();
                    f.setTime(p); return a } return this.useUTC ? f["getUTC" + a]() : f["get" + a]() };
            a.prototype.set =
                function(a, f, q) { if (this.variableTimezone || this.timezoneOffset) { if ("Milliseconds" === a || "Seconds" === a || "Minutes" === a) return f["setUTC" + a](q); var p = this.getTimezoneOffset(f);
                        p = f.getTime() - p;
                        f.setTime(p);
                        f["setUTC" + a](q);
                        a = this.getTimezoneOffset(f);
                        p = f.getTime() + a; return f.setTime(p) } return this.useUTC ? f["setUTC" + a](q) : f["set" + a](q) };
            ...
            a.prototype.makeTime = function(a, t, q, u, m, h) { if (this.useUTC) { var l = this.Date.UTC.apply(0, arguments); var k = this.getTimezoneOffset(l);
                    l += k; var g = this.getTimezoneOffset(l);
                    k !== g ? l += g - k : k - 36E5 !== this.getTimezoneOffset(l - 36E5) || f.isSafari || (l -= 36E5) } else l = (new this.Date(a, t, v(q, 1), v(u, 0), v(m, 0), v(h, 0))).getTime(); return l };
            a.prototype.timezoneOffsetFunction = function() {
                ...
                if (f.timezone) { if (q) return function(a) { return 6E4 * -q.tz(a, f.timezone).utcOffset() };
                    y(25) }
    ...
    O(n, "Core/Axis/Axis.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Axis/Tick.js"], n["Core/Utilities.js"], n["Core/Options.js"]], function(f, a, n, y, D) {
        ...
        y = function() {
            ...
            e.prototype.setOptions = function(c) { this.options = g(e.defaultOptions, "yAxis" === this.coll && e.defaultYAxisOptions, [e.defaultTopAxisOptions, e.defaultRightAxisOptions, e.defaultBottomAxisOptions, e.defaultLeftAxisOptions][this.side], g(R[this.coll], c));
            ...
            e.prototype.translate =
                function(c, b, e, d, g, k) { var h = this.linkedParent || this,
                        a = 1,
                        w = 0,
                        z = d ? h.oldTransA : h.transA;
                    d = d ? h.oldMin : h.min; var r = h.minPixelPadding;
                    g = (h.isOrdinal || h.brokenAxis && h.brokenAxis.hasBreaks || h.logarithmic && g) && h.lin2val;
                    z || (z = h.transA);
                    e && (a *= -1, w = h.len);
                    h.reversed && (a *= -1, w -= a * (h.sector || h.len));
                    b ? (c = (c * a + w - r) / z + d, g && (c = h.lin2val(c))) : (g && (c = h.val2lin(c)), c = l(d) ? a * (c - d) * z + w + a * r + (l(k) ? z * k : 0) : void 0); return c };
            ...
            e.prototype.getPlotLinePath = function(c) {
                ...
                t(this, "getPlotLinePath",
                    c,
                    function(c) { m = r(m, e.translate(a, null, null, h));
                        m = v(m, -1E5, 1E5);
                        p = A = Math.round(m + N);
            ...
            e.prototype.adjustForMinRange = function() {
                ...
                if (e - b < this.minRange) { var m = this.dataMax - this.dataMin >= this.minRange; var x = this.minRange; var f = (x - e + b) / 2;
                    f = [b - f, r(c.min, b - f)];
            ...
            e.prototype.getClosest = function() { var c;
                this.categories ? c = 1 : this.series.forEach(function(b) { var e = b.closestPointRange,
                        d = b.visible || !b.chart.options.chart.ignoreHiddenSeries;!b.noSharedTooltip && q(e) && d && (c = q(c) ? Math.min(c, e) : e) }); return c };
            ...
            e.prototype.setTickInterval = function(c) {
                ...
                if (a) { b.linkedParent = e[b.coll][k.linkedTo]; var N = b.linkedParent.getExtremes();
                    b.min = r(N.min, N.dataMin);
                    b.max = r(N.max, N.dataMax);
                    k.type !== b.linkedParent.options.type && E(11, 1, e) } else {
                    if (Q && q(A))
                        if (b.dataMin >= A) N = A, x = 0;
                        else if (b.dataMax <= A) { var v = A;
                        m = 0 }
                    b.min =
                        r(M, N, b.dataMin);
            ...
            e.prototype.alignToOthers = function() { var c = {},
                    b, e = this.options;!1 === this.chart.options.chart.alignTicks || !1 === e.alignTicks || !1 === e.startOnTick || !1 === e.endOnTick || this.logarithmic || this.chart[this.coll].forEach(function(e) { var d = e.options;
                    d = [e.horiz ? d.left : d.top, d.width, d.height, d.pane].join();
                    e.series.length && (c[d] ? b = !0 : c[d] = 1) }); return b };
            ...
            e.prototype.adjustTickAmount = function() {
                ...
                if (this.hasData()) {
                    ...
                    if (q(g)) { for (b = c = e.length; b--;)(3 === g && 1 === b % 2 || 2 >= g && 0 < b && b < c - 1) && e.splice(b, 1);
            ...
            e.prototype.setExtremes = function(c, b, e, d, g) { var k = this,
                    h = k.chart;
                e = r(e, !0);
                k.series.forEach(function(b) { delete b.kdTree });
                g = p(g, { min: c, max: b });
                t(k, "setExtremes", g, function() { k.userMin = c;
                    k.userMax = b;
                    k.eventArgs = g;
                    e && h.redraw(d) }) };
            e.prototype.zoom = function(c, b) {
                var e = this,
                    ...
                    a = Math.max(g,
                        r(k.max, g));
                c = { newMin: c, newMax: b };
                t(this, "zoom", c, function(b) { var c = b.newMin,
                        k = b.newMax; if (c !== e.min || k !== e.max) e.allowZoomOutside || (q(d) && (c < h && (c = h), c > a && (c = a)), q(g) && (k < h && (k = h), k > a && (k = a))), e.displayBtn = "undefined" !== typeof c || "undefined" !== typeof k, e.setExtremes(c, k, !1, void 0, { trigger: "zoom" });
                    b.zoomed = !0 });
                return c.zoomed
            };
            ...
            e.prototype.getThreshold = function(c) { var b = this.logarithmic,
                    e = b ? b.lin2log(this.min) : this.min;
                b = b ? b.lin2log(this.max) : this.max;
                null === c || -Infinity === c ? c = e : Infinity === c ? c = b : e > c ? c = e : b < c && (c = b); return this.translate(c, 0, 1, 0, 1) };
            e.prototype.autoLabelAlign = function(c) { var b = (r(c, 0) - 90 * this.side + 720) % 360;
                c = { align: "center" };
                t(this, "autoLabelAlign", c, function(c) { 15 < b && 165 > b ? c.align = "right" : 195 < b && 345 > b && (c.align = "left") }); return c.align };
            ...
            e.prototype.unsquish =
                function() {
                    var c = this.options.labels,
                        ...
                        p = function(b) { var c = b / (g || 1);
                            c = 1 < c ? Math.ceil(c) : 1;
                            c * e > f && Infinity !== b && Infinity !== g && f && (c = Math.ceil(f / e)); return L(c * e) };
            ...
            e.prototype.renderUnsquish = function() {
                ...
                if (this.labelAlign = g.align || this.autoLabelAlign(this.labelRotation)) r.align =
                    this.labelAlign;
                e.forEach(function(b) { var c = (b = d[b]) && b.label,
                        e = h.width,
                        g = {};
                    c && (c.attr(r), b.shortenLabel ? b.shortenLabel() : B && !e && "nowrap" !== h.whiteSpace && (B < c.textPxLength || "SPAN" === c.element.tagName) ? (g.width = B + "px", f || (g.textOverflow = c.specificTextOverflow || A), c.css(g)) : c.styles && c.styles.width && !g.width && !e && c.css({ width: null }), delete c.specificTextOverflow, b.rotation = r.rotation) }, this);
            ...
            e.prototype.generateTick = function(c) { var b = this.ticks;
            ...
            e.prototype.getLinePath = function(c) { var b = this.chart,
                    e = this.opposite,
                    d = this.offset,
                    g = this.horiz,
                    k = this.left + (e ? this.width : 0) + d;
                d = b.chartHeight - this.bottom - (e ? this.height : 0) + d;
                e && (c *= -1); return b.renderer.crispLine([
            ...
            e.prototype.renderMinorTick = function(c) { var b = this.chart.hasRendered && l(this.oldMin),
                    e = this.minorTicks;
            ...
            e.prototype.render = function() {
                ...
                [m, r, f].forEach(function(c) { var e, d = [],
                        g = u.duration;
            ...
            e.prototype.redraw = function() { this.visible && (this.render(), this.plotLinesAndBands.forEach(function(c) { c.render() }));
            ...
            e.prototype.hideCrosshair = function() { this.cross && this.cross.hide();
    ...
    O(n, "Core/Axis/LogarithmicAxis.js", [n["Core/Axis/Axis.js"], n["Core/Utilities.js"]], function(f, a) {
            ...
            C = function() {
                ...
                a.prototype.getLogTickPositions = function(a, f, n, q) {
                    ...
                    if (.5 <= a) a = Math.round(a), t = v.getLinearTickPositions(a, f, n);
                        ...
                        a) { p = Math.floor(f); var I, u; for (E = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; p < n + 1 && !u; p++) { var m = E.length; for (I = 0; I < m && !u; I++) { var h = this.log2lin(this.lin2log(p) * E[I]);
                                h > f && (!q || l <= n) && "undefined" !== typeof l && t.push(l);
                                l > n && (u = !0); var l = h } } } else f = this.lin2log(f), n = this.lin2log(n), a = q ? v.getMinorTickInterval() : p.tickInterval, a = G("auto" === a ? null : a, this.minorAutoInterval, p.tickPixelInterval / (q ? 5 : 1) * (n - f) / ((q ? E / v.tickPositions.length : E) || 1)), a = D(a, void 0, y(a)), t = v.getLinearTickPositions(a, f, n).map(this.log2lin),
        ...
        a = function() {
            ...
            a.compose = function(a) {
                ...
                n(a, "afterInit", function() { var a = this.logarithmic;
    ...
    O(n, "Core/Axis/PlotLineOrBand.js", [n["Core/Axis/Axis.js"], n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a, n) {
        var y = n.arrayMax,
            ...
            K = function() {
                ...
                f.prototype.destroy = function() { J(this.axis.plotLinesAndBands, this);
                    delete this.axis;
                    C(this) };
                return f
            }();
        H(f.prototype, {
            getPlotBandPath: function(a, f) {
                ...
                if (q && p) {
                    ...
                    for (a = 0; a < q.length; a += 2) { f = q[a]; var k = q[a + 1],
                            g = p[a],
                            d = p[a + 1]; "M" !== f[0] && "L" !== f[0] || "M" !== k[0] && "L" !== k[0] || "M" !== g[0] && "L" !== g[0] || "M" !== d[0] && "L" !== d[0] || (m && g[1] === f[1] ? (g[1] += h, d[1] += h) : m || g[2] !== f[2] || (g[2] += h, d[2] += h), u.push(["M", f[1], f[2]], ["L", k[1], k[2]], ["L", d[1], d[2]], ["L", g[1], g[2]], ["Z"]));
                        u.isFlat = l }
                }
                return u
            },
            ...
            removePlotBandOrLine: function(a) { for (var f = this.plotLinesAndBands, t = this.options, q = this.userOptions, u = f.length; u--;) f[u].id === a && f[u].destroy();
    ...
    O(n, "Core/Tooltip.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        var u = function() {
            ...
            m.prototype.cleanSplit = function(h) { this.chart.series.forEach(function(a) { var k = a && a.tt;
            ...
            m.prototype.destroy = function() { this.label && (this.label = this.label.destroy());
            ...
            m.prototype.getAnchor = function(h, a) {
                var k = this.chart,
                    ...
                    B, M;
                h = p(h);
                this.followPointer && a ? ("undefined" === typeof a.chartX && (a = g.normalize(a)), h = [a.chartX - f, a.chartY - l]) : h[0].tooltipPos ? h = h[0].tooltipPos : (h.forEach(function(g) { B = g.series.yAxis;
                    M = g.series.xAxis;
                    m += g.plotX + (!d && M ? M.left - f : 0);
                    t += (g.plotLow ? (g.plotLow + g.plotHigh) / 2 : g.plotY) + (!d && B ? B.top - l : 0) }), m /= h.length, t /= h.length, h = [d ? k.plotWidth - t : m, this.shared && !d && 1 < h.length && a ? a.chartY - l : d ? k.plotHeight - m : t]);
            ...
            m.prototype.getLabel = function() {
                ...
                var B = function() { var e = k.chart.hoverSeries;
                    k.inContact = !1; if (e && e.onMouseOut) e.onMouseOut() };
                if (!this.label) {
                    ...
                    if (k.outside && !k.split) {
                        ...
                        M.ySetter = function(e) { F.call(M, k.distance);
                            t.style.top = e + "px" }
                    }
            ...
            m.prototype.getPosition = function(a, l, k) {
                var g = this.chart,
                    ...
                    v = function(b, c, e, g, k) { var a;
                        k < d || k > c - d ? a = !1 : h[b] = k < e / 2 ? 1 : k > c - g / 2 ? c - g - 2 : k - e / 2; return a },
                    I = function(b) { var c = z;
                        z = w;
                        w = c;
                        m = b },
            ...
            m.prototype.hide = function(h) { var l = this;
                a.clearTimeout(this.hideTimer);
                h = E(h, this.options.hideDelay, 500);
                this.isHidden || (this.hideTimer = t(function() { l.getLabel().fadeOut(h ? void 0 : h);
                    l.isHidden = !0 }, h)) };
            ...
            m.prototype.renderSplit = function(a, l) {
                function k(b, c, e, d, g) { void 0 === g && (g = !0);
                    e ? (c = H ? 0 : G, b = y(b - d / 2, n.left, n.right - d)) : (c -= K, b = g ? b - d - z : b + z, b = y(b, g ? b : n.left, n.right)); return { x: b, y: c } }
                var g = this,
                    d = g.chart,
                    h = g.chart,
                    m = h.plotHeight,
                ...
                g.cleanSplit();
                f.distribute(a, G);
                a.forEach(function(b) { var c = b.pos;
            ...
            m.prototype.tooltipFooterHeaderFormatter = function(a, l) {
                ...
                H(this, "headerFormatter", l, function(k) { m && !h && (h = this.getXDateFormat(a, d, f));
            ...
            m.prototype.update = function(a) { this.destroy();
            ...
            m.prototype.updatePosition =
                function(a) {
                    ...
                    if (this.outside) { var m = (this.options.borderWidth || 0) + 2 * this.distance;
                        this.renderer.setSize(g.width + m, g.height + m, !1); if (h = h.containerScaling) D(this.container, { transform: "scale(" + h.scaleX + ", " + h.scaleY + ")" }), d *= h.scaleX, f *= h.scaleY;
                        d += k.left - a.x;
                        f += k.top - a.y }
    ...
    O(n, "Core/Pointer.js", [n["Core/Color.js"], n["Core/Globals.js"], n["Core/Tooltip.js"], n["Core/Utilities.js"]], function(f, a, n, y) {
        ...
        f = function() {
            ...
            l.prototype.applyInactiveState = function(a) { var g = [],
                    d;
            ...
            l.prototype.dragStart = function(a) { var g = this.chart;
            ...
            l.prototype.drop = function(a) {
                ...
                if (this.selectionMarker) {
                    var h = { originalEvent: a, xAxis: [], yAxis: [] },
                        ...
                        F;
                    if (this.hasDragged || k) d.axes.forEach(function(e) { if (e.zoomEnabled && L(e.min) && (k || g[{ xAxis: "zoomX", yAxis: "zoomY" }[e.coll]]) && p(f) && p(m)) { var c = e.horiz,
                                b = "touchend" === a.type ? e.minPixelPadding : 0,
                                d = e.toValue((c ? f : m) + b);
                            c = e.toValue((c ? f + t : m + u) - b);
                            h[e.coll].push({ axis: e, min: Math.min(d, c), max: Math.max(d, c) });
                            F = !0 } }), F && E(d, "selection", h, function(e) { d.zoom(q(e, k ? { animation: !1 } : null)) });
            ...
            l.prototype.findNearestKDPoint = function(a, g, d) {
                ...
                a.forEach(function(a) {
                    ...
                    a = a.searchPoint(d, k);
                    if ((k =
                            t(a, !0)) && !(k = !t(l, !0))) { k = l.distX - a.distX; var h = l.dist - a.dist,
            ...
            l.prototype.getCoordinates = function(a) { var g = { xAxis: [], yAxis: [] };
                this.chart.axes.forEach(function(d) { g[d.isXAxis ? "xAxis" : "yAxis"].push({ axis: d, value: d.toValue(a[d.horiz ? "chartX" : "chartY"]) }) }); return g };
            l.prototype.getHoverData = function(a, g, d, h, l, f) {
                ...
                k && (l && !g.noSharedTooltip ? (p = d.filter(function(d) { return x.filter ? x.filter(d) : d.visible && !(!l && d.directTouch) && m(d.options.enableMouseTracking, !0) && !d.noSharedTooltip }), p.forEach(function(d) { var e = K(d.points, function(c) { return c.x === k.x && !c.isNull });
            ...
            l.prototype.onTrackerMouseOut = function(a) { a = a.relatedTarget || a.toElement; var g = this.chart.hoverSeries;
                this.isDirectTouch = !1; if (!(!g || !a || g.stickyTracking || this.inClass(a, "highcharts-tooltip") || this.inClass(a, "highcharts-series-" + g.index) && this.inClass(a, "highcharts-tracker"))) g.onMouseOut() };
            l.prototype.inClass = function(a, g) { for (var d; a;) { if (d = H(a, "class")) { if (-1 !== d.indexOf(g)) return !0; if (-1 !== d.indexOf("highcharts-container")) return !1 }
                    a = a.parentNode } };
            l.prototype.init = function(a, g) { this.options = g;
                this.chart = a;
            ...
            l.prototype.onContainerMouseDown = function(k) { var g = 1 === ((k.buttons || k.button) & 1);
                k = this.normalize(k); if (a.isFirefox && 0 !== k.button) this.onContainerMouseMove(k); if ("undefined" === typeof k.button || g) this.zoomOption(k), g && k.preventDefault && k.preventDefault(), this.dragStart(k) };
            ...
            l.prototype.onContainerMouseMove = function(a) { var g = this.chart;
                a = this.normalize(a);
                this.setHoverChartIndex();
                a.preventDefault || (a.returnValue = !1); "mousedown" === g.mouseIsDown && this.drag(a);
            ...
            l.prototype.onContainerTouchStart = function(a) { this.zoomOption(a);
                this.touch(a, !0) };
            l.prototype.onDocumentMouseMove = function(a) { var g = this.chart,
                    d = this.chartPosition;
                a = this.normalize(a, d); var h = g.tooltip;!d || h && h.isStickyOnContact() || g.isInsidePlot(a.chartX - g.plotLeft, a.chartY - g.plotTop) || this.inClass(a.target, "highcharts-tracker") || this.reset() };
            ...
            l.prototype.pinch = function(a) {
                ...
                "touchstart" === a.type ? ([].forEach.call(k, function(c, b) { h[b] = { chartX: c.chartX, chartY: c.chartY } }), f.x = [h[0].chartX, h[1] && h[1].chartX],
                    f.y = [h[0].chartY, h[1] && h[1].chartY], d.axes.forEach(function(c) { if (c.zoomEnabled) { var b = d.bounds[c.horiz ? "h" : "v"],
                                e = c.minPixelPadding,
                            ...
                            b.max = Math.max(c.pos + c.len, h + e) } }), g.res = !0) : g.followTouchMove && 1 === l ? this.runPointActions(g.normalize(a)) : h.length && (t || (g.selectionMarker = t = q({ destroy: C, touch: !0 }, d.plotBox)), g.pinchTranslate(h,
                    k, u, t, e, f), g.hasPinched = p, g.scaleGroups(u, e), g.res && (g.res = !1, this.reset(!1, 0)))
            };
            l.prototype.pinchTranslate = function(a, g, d, h, l, f) { this.zoomHor && this.pinchTranslateDirection(!0, a, g, d, h, l, f);
            ...
            l.prototype.pinchTranslateDirection = function(a, g, d, h, l, f, m, p) {
                var k = this.chart,
                    ...
                    g[1][e],
                    N = !q && d[1][e];
                d = function() { "number" === typeof N && 20 < Math.abs(v - I) && (t = p || Math.abs(n - N) / Math.abs(v - I));
                    w = (b - n) / t + v;
            ...
            l.prototype.reset = function(a, g) {
                ...
                if (a) m && p && h(p).length && (m.refresh(p), m.shared && f ? f.forEach(function(d) { d.setState(d.state, !0);
                    d.series.isCartesian && (d.series.xAxis.crosshair && d.series.xAxis.drawCrosshair(null, d), d.series.yAxis.crosshair && d.series.yAxis.drawCrosshair(null, d)) }) : l && (l.setState(l.state, !0), d.axes.forEach(function(d) { d.crosshair && l.series[d.coll] === d && d.drawCrosshair(null, l) })));
                else {
                    if (l) l.onMouseOut();
            ...
            l.prototype.runPointActions = function(h, g) {
                ...
                d.axes.forEach(function(g) { var a = m((g.crosshair || {}).snap, !0),
                        k;
            ...
            l.prototype.scaleGroups = function(a, g) {
                var d =
                    this.chart,
                    h;
                d.series.forEach(function(k) { h = a || k.getPlotBox();
            ...
            l.prototype.setHoverChartIndex =
                function() { var h = this.chart,
                        g = a.charts[m(a.hoverChartIndex, -1)]; if (g && g !== h) g.pointer.onContainerMouseLeave({ relatedTarget: !0 });
            ...
            l.prototype.zoomOption = function(a) { var g = this.chart,
                    d = g.options.chart,
                    h = d.zoomType || "";
                g = g.inverted; /touch/.test(a.type) && (h = m(d.pinchType, h));
    ...
    O(n, "Core/MSPointer.js", [n["Core/Globals.js"], n["Core/Pointer.js"], n["Core/Utilities.js"]], function(f, a,
        ...
        function y() { var a = [];
            ...
            q(E, function(f) { a.push({ pageX: f.pageX, pageY: f.pageY, target: f.target }) }); return a }
        ...
        return function(a) {
            ...
            f.prototype.destroy = function() { this.batchMSEvents(K);
                a.prototype.destroy.call(this) };
            f.prototype.init = function(f, m) { a.prototype.init.call(this, f, m);
            ...
            f.prototype.onContainerPointerMove = function(a) { D(a, "onContainerTouchMove", "touchmove", function(a) { E[a.pointerId] = { pageX: a.pageX, pageY: a.pageY };
            ...
            f.prototype.setDOMEvents = function() { a.prototype.setDOMEvents.call(this);
            ...
            l = function() {
                ...
                a.prototype.init = function(a, d) {
                    ...
                    d.enabled && (this.render(), n(this.chart, "endResize", function() { this.legend.positionCheckboxes() }),
                        this.proximate ? this.unchartrender = n(this.chart, "render", function() { this.legend.proximatePositions();
                ...
                a.prototype.update = function(a, d) { var g = this.chart;
                ...
                a.prototype.destroyItem = function(a) { var d = a.checkbox;
                ...
                a.prototype.positionCheckboxes = function() { var a = this.group && this.group.alignAttr,
                        ...
                        h = this.titleHeight; if (a) { var k = a.translateY;
                        this.allItems.forEach(function(g) { var f = g.checkbox; if (f) { var l = k + h + f.y + (this.scrollOffset || 0) + 3;
                                D(f, { left: a.translateX + g.checkboxOffset + f.x - 20 + "px", top: l + "px", display: this.proximate || l > k - 6 && l < k + d - 6 ? "" : "none" }) } }, this) } };
                a.prototype.renderTitle = function() { var a = this.options,
                        d = this.padding,
                        h = a.title,
                        k = 0;
                ...
                a.prototype.getAllItems = function() {
                    var a = [];
                    this.chart.series.forEach(function(d) { var g = d && d.options;
                ...
                a.prototype.handleOverflow = function(a) {
                    ...
                    var m = k.maxHeight,
                        ...
                        v = function(c) { d[c] = h.circle(0, 0, 1.3 * b).translate(b / 2, b / 2).add(z);
                            g.styledMode || d[c].attr("fill", "rgba(0,0,0,0.0001)"); return d[c] };
    ...
    O(n, "Core/Chart/Chart.js", [n["Core/Axis/Axis.js"], n["Core/Globals.js"], n["Core/Legend.js"], n["Core/MSPointer.js"], n["Core/Options.js"], n["Core/Pointer.js"], n["Core/Time.js"], n["Core/Utilities.js"]], function(f, a, n, y, D, G, C, J) {
        var H = a.charts,
            ...
            Y = function() {
                ...
                D.prototype.initSeries = function(b) { var c = this.options.chart;
                    c = b.type || c.type || c.defaultSeriesType; var e = L[c];
                ...
                D.prototype.isInsidePlot =
                    function(b, c, e) { var d = e ? c : b;
                        b = e ? b : c;
                        d = { x: d, y: b, isInsidePlot: 0 <= d && d <= this.plotWidth && 0 <= b && b <= this.plotHeight };
                        r(this, "afterIsInsidePlot", d); return d.isInsidePlot };
                D.prototype.redraw = function(b) {
                    ...
                    a.forEach(function(b) { b.isDirty && ("point" === b.options.legendType ? (b.updateTotals && b.updateTotals(), l = !0) : k && (k.labelFormatter || k.labelFormat) && (l = !0));
                    ...
                    f && (e.forEach(function(b) {
                        b.isDirty &&
                            (m = !0)
                    }), e.forEach(function(b) { var c = b.min + "," + b.max;
                        b.extKey !== c && (b.extKey = c, z.push(function() { r(b, "afterSetExtremes", d(b.eventArgs, b.getExtremes()));
                            delete b.eventArgs }));
                        (m || B) && b.redraw() }));
                    m && c.drawChartBox();
                    r(c, "predraw");
                ...
                D.prototype.getAxes = function() { var b = this,
                        c = this.options,
                        e = c.xAxis = aa(c.xAxis || {});
                    c = c.yAxis = aa(c.yAxis || {});
                    r(this, "getAxes");
                    e.forEach(function(b, c) { b.index = c;
                        b.isX = !0 });
                ...
                D.prototype.setTitle = function(b, c, e) { this.applyDescription("title", b);
                ...
                D.prototype.layOutTitles = function(b) {
                    ...
                    ["title", "subtitle", "caption"].forEach(function(b) {
                        ...
                        if (g) { if (!this.styledMode) var l = h.style.fontSize;
                            l = e.fontMetrics(l, g).b;
                            g.css({ width: (h.width || a.width + (h.widthAdjust || 0)) + "px" }); var f = Math.round(g.getBBox(h.useHTML).height);
                ...
                D.prototype.reflow = function(b) { var c = this,
                        e = c.options.chart,
                        d = c.renderTo,
                        a = h(e.width) && h(e.height),
                        g = e.width || A(d, "width");
                    e = e.height || A(d, "height");
                    d = b ? b.target : q; if (!a && !c.isPrinting && g && e && (d === q || d === v)) { if (g !== c.containerWidth || e !== c.containerHeight) J.clearTimeout(c.reflowTimeout), c.reflowTimeout = X(function() { c.container && c.setSize(void 0, void 0, !1) }, b ? 100 : 0);
                        c.containerWidth = g;
                        c.containerHeight = e } };
                ...
                D.prototype.drawChartBox = function() {
                    ...
                    else { n = b.borderWidth || 0;
                        w = n + (b.shadow ? 8 : 0);
                        l = { fill: l || "none" }; if (n || a["stroke-width"]) l.stroke = b.borderColor, l["stroke-width"] = n;
                ...
                D.prototype.propFromSeries = function() { var b = this,
                        ...
                        a, g;
                    ["inverted", "angular", "polar"].forEach(function(h) { e = L[c.type || c.defaultSeriesType];
                        g = c[h] || e && e.prototype[h]; for (a = d && d.length; !g && a--;)(e = L[d[a].type]) && e.prototype[h] && (g = !0);
                        b[h] = g }) };
                ...
                D.prototype.renderSeries = function() { this.series.forEach(function(b) { b.translate();
                        b.render() }) };
                ...
                D.prototype.render = function() {
                    ...
                    if (k || l) b.forEach(function(b) {
                        (b.horiz && k || !b.horiz && l) && b.setTickInterval(!0) }), this.getMargins();
                    this.drawChartBox();
                ...
                D.prototype.addCredits = function(b) {
                    ...
                    d.enabled && !this.credits && (this.credits = this.renderer.text(d.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click", function() { d.href && (q.location.href = d.href) }).attr({ align: d.position.align, zIndex: 8 }), c.styledMode || this.credits.css(d.style), this.credits.add().align(d.position), this.credits.update = function(b) { c.credits = c.credits.destroy();
                        c.addCredits(b) })
                };
                D.prototype.updateContainerScaling = function() {
                    var b = this.container;
                    if (2 < b.offsetWidth &&
                        2 < b.offsetHeight && b.getBoundingClientRect) { var c = b.getBoundingClientRect(),
                ...
                D.prototype.destroy = function() {
                    ...
                    "title subtitle chartBackground plotBackground plotBGImage plotBorder seriesGroup clipRect credits pointer rangeSelector legend resetZoomButton tooltip renderer".split(" ").forEach(function(b) { var e = c[b];
            ...
            if (!this.renderer.forExport) {
                if (v) {
                    if (this.scrollablePixelsX =
                        v = Math.max(0, v - this.chartWidth)) { this.plotWidth += v;
                        this.inverted ? (this.clipBox.height += v, this.plotBox.height += v) : (this.clipBox.width += v, this.plotBox.width += v); var C = { 1: { name: "right", value: v } } }
    ...
    O(n, "Core/Axis/StackingAxis.js", [n["Core/Utilities.js"]], function(f) {
        var a = f.addEvent,
            ...
            J = function() {
                ...
                a.prototype.buildStacks = function() { var a = this.axis,
                        ...
                        n = f.length,
                        E; if (!a.isXAxis) { this.usePercentage = !1; for (E = n; E--;) { var p = f[q ? E : n - E - 1];
                            p.setStackedPoints();
                            p.setGroupedPoints() } for (E = 0; E < n; E++) f[E].modifyStacks();
        ...
        return function() {
            function f() {}
            f.compose = function(n) { a(n, "init", f.onInit);
                a(n, "destroy", f.onDestroy) };
            f.onDestroy = function() { var a = this.stacking; if (a) { var f = a.stacks;
                    G(f, function(a, v) { n(a);
                        f[v] = null });
                    a && a.stackTotalGroup && a.stackTotalGroup.destroy() } };
            f.onInit = function() { this.stacking || (this.stacking = new J(this)) }; return f }()
    });
    O(n, "Mixins/LegendSymbol.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        var n = a.merge,
            y = a.pick;
        return f.LegendSymbolMixin = {
            drawRectangle: function(a, f) { var n = a.symbolHeight,
    ...
    O(n, "Core/Series/Point.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        "";
        a = function() {
            function a() { this.colorIndex = this.category = void 0;
            ...
            a.prototype.animateBeforeDestroy =
                function() { var a = this,
                    ...
                    l.singular.forEach(function(k) { h = "dataLabel" === k;
            ...
            a.prototype.destroy =
                function() {
                    function a() { if (f.graphic || f.dataLabel || f.dataLabels) p(f), f.destroyElements(); for (d in f) f[d] = null } var f = this,
                        h = f.series,
                        l = h.chart;
                    h = h.options.dataSorting; var k = l.hoverPoints,
                        g = n(f.series.chart.renderer.globalAnimation),
                        d;
                    f.legendItem && l.legend.destroyItem(f);
                    k && (f.setState(), D(k, f), k.length || (l.hoverPoints = null)); if (f === l.hoverPoint) f.onMouseOut();
            ...
            a.prototype.destroyElements = function(a) {
                ...
                a.plural.forEach(function(a) { f[a].forEach(function(a) { a.element && a.destroy() });
                    delete f[a] })
            };
            a.prototype.firePointEvent = function(a, f, h) { var l = this,
                    k = this.series.options;
                (k.point.events[a] || l.options && l.options.events && l.options.events[a]) && l.importEvents(); "click" === a && k.allowPointSelect && (h = function(a) { l.select && l.select(null, a.ctrlKey || a.metaKey || a.shiftKey) });
                C(l, a, f, h) };
            ...
            a.prototype.getGraphicalProps = function(a) {
                ...
                for (l = h.length; l--;) { var g = h[l];
                    f[g] && k.singular.push(g) }["dataLabel", "connector"].forEach(function(d) { var g = d + "s";
            ...
            a.prototype.getZone = function() { var a = this.series,
                    f = a.zones;
                a = a.zoneAxis || "y"; var h = 0,
                    l; for (l = f[h]; this[a] >= l.value;) l = f[++h];
                this.nonZonedColor || (this.nonZonedColor = this.color);
                this.color = l && l.color && !this.options.color ? l.color : this.nonZonedColor; return l };
    ...
    O(n, "Core/Series/Series.js", [n["Core/Globals.js"], n["Mixins/LegendSymbol.js"], n["Core/Options.js"], n["Core/Series/Point.js"], n["Core/Renderer/SVG/SVGElement.js"], n["Core/Utilities.js"]], function(f, a, n, y, D, G) {
        ...
        f.Series = n("line", null, {
            ...
            insert: function(e) { var c = this.options.index,
                    b; if (g(c)) { for (b = e.length; b--;)
                        if (c >= A(e[b].options.index, e[b]._i)) { e.splice(b + 1, 0, this); break } - 1 === b && e.unshift(this);
                    b += 1 } else e.push(this); return A(b, e.length - 1) },
            bindAxes: function() {
                var e = this,
                    c = e.options,
                    b = e.chart,
                ...
                m(this, "bindAxes", null, function() {
                    (e.axisTypes || []).forEach(function(d) { b[d].forEach(function(b) { a = b.options; if (c[d] === a.index || "undefined" !== typeof c[d] && c[d] === a.id || "undefined" === typeof c[d] && 0 === a.index) e.insert(b.series), e[d] = b, b.isDirty = !0 });
                        e[d] || e.optionalAxis === d || t(18, !0, b) })
                });
                m(this, "afterBindAxes")
            },
            updateParallelArrays: function(e, c) { var b = e.series,
                    a = arguments,
                    d = g(c) ? function(a) { var d = "y" === a && b.toYData ? b.toYData(e) : e[a];
                        b[a + "Data"][c] = d } : function(e) { Array.prototype[c].apply(b[e + "Data"], Array.prototype.slice.call(a, 2)) };
            ...
            setDataSortingOptions: function() { var e = this.options;
            ...
            findPointIndex: function(e, c) {
                ...
                if (b) var k = this.chart.get(b);
                    ...
                    k = u(d, function(b) { return !b.touched && b[l] === e[l] }); if (!k) return }
            ...
            sortData: function(e) {
                ...
                e.forEach(function(b, d) { e[d] = a(c, b);
                    e[d].index = d }, this);
                ...
                c.linkedSeries && c.linkedSeries.forEach(function(b) { var c = b.options,
                        d = c.data;
                    c.dataSorting && c.dataSorting.enabled || !d || (d.forEach(function(c, g) { d[g] = a(b, c);
                        e[g] && (d[g].x = e[g].x, d[g].index = g) }), b.setData(d, !1)) });
                return e
            },
            getProcessedData: function(e) {
                ...
                if (l && this.sorted && !k && (!f || a > f || this.forceCrop))
                    ...
                    else if (this.yData && (c[0] < p || c[a - 1] > r)) { d = this.cropData(this.xData, this.yData, p, r);
                    c = d.xData;
                    b = d.yData;
                    d = d.start; var B = !0 }
                for (f = c.length || 1; --f;)
            ...
            generatePoints: function() {
                ...
                for (r = 0; r < f; r++) {
                    var t = k + r;
                    if (l) { var n = (new h).init(this, [d[r]].concat(B(g[r])));
                        n.dataGroup = this.groupMap[r];
                        n.dataGroup.options && (n.options = n.dataGroup.options, I(n, n.dataGroup.options), delete n.dataLabels) } else(n =
            ...
            getExtremes: function(e, c) {
                ...
                for (B = 0; B < a; B++) { var n = d[B]; var q = e[B]; var x = (g(q) || l(q)) && (q.length || 0 < q || !t);
                    n = c || this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || !b || (d[B + r] || n) >= k && (d[B - r] || n) <= p; if (x && n)
                        if (x = q.length)
                            for (; x--;) g(q[x]) && (h[f++] = q[x]);
                        else h[f++] = q }
            ...
            animate: function(e) { var c = this.chart,
                    b = H(this.options.animation); if (!c.hasRendered)
                    if (e) this.setClip(b);
                    else { var a = this.sharedClipKey;
                        e = c[a]; var d = this.getClipBox(b, !0);
                        e && e.animate(d, b);
            ...
            getZonesGraphs: function(a) {
                this.zones.forEach(function(c, b) { b = ["zone-graph-" + b, "highcharts-graph highcharts-zone-graph-" + b + " " + (c.className || "")];
            ...
            invertGroups: function(a) {
                function c() {
                    ["group", "markerGroup"].forEach(function(c) { b[c] && (e.renderer.isVML && b[c].attr({ width: b.yAxis.len, height: b.xAxis.len }), b[c].width = b.yAxis.len, b[c].height = b.xAxis.len, b[c].invert(b.isRadialSeries ? !1 : a)) }) } var b = this,
                    e = b.chart;
            ...
            buildKDTree: function(a) {
                function c(a, d, e) { var g; if (g = a && a.length) { var h = b.kdAxisArray[d % e];
                        a.sort(function(b, c) { return b[h] - c[h] });
                        g = Math.floor(g / 2); return { point: a[g], left: c(a.slice(0, g), d + 1, e), right: c(a.slice(g + 1), d + 1, e) } } }
            ...
            pointPlacementToXValue: function() { var a = this.options,
                    c = a.pointRange,
                    b = this.xAxis;
                a = a.pointPlacement; "between" === a && (a = b.reversed ? -.5 : .5); return g(a) ? a * A(c, b.pointRange) : 0 },
    ...
    O(n, "Extensions/Stacking.js", [n["Core/Axis/Axis.js"], n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Axis/StackingAxis.js"], n["Core/Utilities.js"]], function(f, a, n, y, D) {
        ...
        q.prototype.percentStacker = function(a, f, n) { f = f.total ? 100 / f.total : 0;
            a[0] = G(a[0] * f);
            a[1] = G(a[1] * f);
            this.stackedYData[n] = a[1] };
        q.prototype.getStackIndicator = function(a, f, n, q) {!C(a) || a.x !== f || q && a.key !== q ? a = { x: f, index: 0, key: q } : a.index++;
            a.key = [n, f, a.index].join(); return a };
        n.StackItem = K;
        return n.StackItem
    });
    O(n, "Core/Dynamics.js", [n["Core/Axis/Axis.js"], n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Options.js"], n["Core/Series/Point.js"], n["Core/Time.js"],
        ...
        t(a.prototype, {
            addSeries: function(a, g, h) { var f, e = this;
                a && (g = d(g, !0), I(e, "addSeries", { options: a }, function() { f = e.initSeries(a);
                    e.isDirtyLegend = !0;
                    e.linkSeries();
                    f.enabledDataSorting && f.setData(a.data, !1);
                    I(e, "afterAddSeries", { series: f });
                    g && e.redraw(h) })); return f },
            ...
            createAxis: function(a,
                g) { var h = this.options,
                    l = "colorAxis" === a,
                    e = g.redraw,
                    c = g.animation;
                g = k(g.axis, { index: this[a].length, isX: "xAxis" === a }); var b = l ? new n.ColorAxis(this, g) : new f(this, g);
                h[a] = A(h[a] || {});
                h[a].push(g);
                l && (this.isDirtyLegend = !0, this.axes.forEach(function(b) { b.series = [] }), this.series.forEach(function(b) { b.bindAxes();
                    b.isDirtyData = !0 }));
                d(e, !0) && this.redraw(c); return b },
            ...
            update: function(a, h, f, p) {
                ...
                g(a, function(b, a) { if (e[a] && "function" === typeof e[a].update) e[a].update(b, !1);
                    else if ("function" === typeof e[c[a]]) e[c[a]](b); "chart" !== a && -1 !== e.propsRequireUpdateSeries.indexOf(a) && (r = !0) });
            ...
            setSubtitle: function(a, d) { this.applyDescription("subtitle", a);
                this.layOutTitles(d) },
            setCaption: function(a, d) { this.applyDescription("caption", a);
                this.layOutTitles(d) }
        });
        ...
        t(y.prototype, {
            ...
            removePoint: function(a, g, h) { var f = this,
                    e = f.data,
                    c = e[a],
                    b = f.points,
                    k = f.chart,
                    l = function() { b && b.length === e.length && b.splice(a, 1);
                        e.splice(a, 1);
    ...
    O(n, "Series/AreaSeries.js", [n["Core/Globals.js"], n["Core/Color.js"], n["Mixins/LegendSymbol.js"], n["Core/Utilities.js"]], function(f, a, n, y) {
        ...
        a("area", "line", { threshold: 0 }, {
            ...
            getStackPoints: function(a) {
                ...
                if (this.options.stacking) {
                    ...
                    n.forEach(function(a, g) {
                        ...
                        else { for (h = t; 0 <= h && h < u;) { if (k = E[a].points[h]) { d = k[1]; break }
                                h += m }
            ...
            getGraphPath: function(a) {
                ...
                n = C(n.connectNulls,
                    "percent" === q);
                var l = function(d, f, k) { var l = a[d];
                    d = q && u[l.x].points[I]; var r = l[k + "Null"] || 0;
                    k = l[k + "Cliff"] || 0;
                    l = !0; if (k || r) { var n = (r ? d[0] : d[1]) + k; var x = d[0] + k;
                        l = !!r } else !q && a[f] && a[f].isNull && (n = x = m); "undefined" !== typeof n && (t.push({ plotX: g, plotY: null === n ? h : y.getThreshold(n), isNull: l, isCliff: !0 }), p.push({ plotX: g, plotY: null === x ? h : y.getThreshold(x), doCurve: !1 })) };
                a = a || this.points;
    ...
    O(n, "Series/ColumnSeries.js", [n["Core/Globals.js"], n["Core/Color.js"], n["Mixins/LegendSymbol.js"], n["Core/Utilities.js"]], function(f, a, n, y) {
        ...
        a("column", "line", {
            ...
            translate: function() {
                ...
                a.points.forEach(function(p) {
                    ...
                    var b = c + A,
                        ...
                        w = Math.min(F, t),
                        E = Math.max(F, t) - w;
                    if (g && Math.abs(E) < g) { E = g; var M = !h.reversed && !p.negative || h.reversed && p.negative;
            ...
            pointAttribs: function(a, f) {
                ...
                if (a && this.zones.length) { var x = a.getZone();
    ...
    O(n, "Mixins/CenteredSeries.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        return f.CenteredSeriesMixin = {
            ...
            getStartAndEndRadians: function(a, f) { a = n(a) ? a : 0;
                f = n(f) && f > a && 360 > f - a ? f : a + 360; return { start: G * (a + -90), end: G * (f + -90) } }
        }
    });
        ...
        p("pie", "line", {
            ...
            animate: function(a) {
                var f =
                    ...
                    l = f.points,
                    k = f.startAngleRad;
                a || l.forEach(function(a) { var d = a.graphic,
                        g = a.shapeArgs;
            ...
            generatePoints: function() { u.prototype.generatePoints.call(this);
                this.updateTotals() },
            getX: function(a, f, l) { var h = this.center,
                    g = this.radii ? this.radii[l.index] : h[2] / 2;
                a = Math.asin(J((a - h[1]) / (g + l.labelDistance), -1, 1)); return h[0] + (f ? -1 : 1) * Math.cos(a) * (g + l.labelDistance) + (0 < l.labelDistance ? (f ? -1 : 1) * this.options.dataLabels.padding : 0) },
                ...
                a.points.forEach(function(h) {
                    ...
                    if (!h.isNull && g) {
                        n =
                            h.shapeArgs;
                        k = h.getTranslate();
                        if (!f.styledMode) { var r = h.shadowGroup;
            ...
            drawPoints: function() { var a = this.chart.renderer;
                this.points.forEach(function(f) { f.graphic && f.hasNewShapeType() && (f.graphic = f.graphic.destroy());
            ...
            slice: function(a, f, l) { var h = this.series;
                t(l, h.chart);
                K(f, !0);
            ...
            connectorShapes: {
                fixedOffset: function(a, f, l) { var h = f.breakAt;
                    f = f.touchingSliceAt; return [
                        ["M", a.x, a.y], l.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 * h.x - f.x, 2 * h.y - f.y, h.x, h.y] : ["L", h.x, h.y],
                        ["L", f.x, f.y]
                    ] },
                straight: function(a, f) { f = f.touchingSliceAt; return [
                        ["M", a.x, a.y],
                        ["L", f.x, f.y]
                    ] },
    ...
    O(n, "Core/Series/DataLabels.js", [n["Core/Globals.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        f.distribute = function(a, l, k) {
            ...
            if (q > t) { u(a, function(a, d) { return (d.rank || 0) - (a.rank || 0) }); for (q = d = 0; q <= t;) q += a[d].size, d++;
            ...
            m.push.apply(m, n);
            d = 0;
            a.some(function(a) { var g = 0; if (a.targets.some(function() { m[d].pos = a.pos + g; if ("undefined" !== typeof k && Math.abs(m[d].pos - m[d].target) > k) return m.slice(0, d + 1).forEach(function(a) { delete a.pos }), m.reducedLen = (m.reducedLen || l) - .1 * l, m.reducedLen > .1 * l && f.distribute(m, l, k), !0;
                        g += m[d].size;
                        d++ })) return !0 });
            u(m, g)
        };
        ...
        y.pie && (y.pie.prototype.dataLabelPositioners = {
                ...
                alignToConnectors: function(a, f, k, g) { var d = 0,
                        h;
                    a.forEach(function(a) { h = a.dataLabel.getBBox().width;
                        h > d && (d = h) }); return f ? d + g : k - d - g }
                ...
                a.visible && (d.enabled || a._hasPointLabels) && (l.forEach(function(a) {
            ...
            }, y.pie.prototype.placeDataLabels = function() { this.points.forEach(function(a) { var f = a.dataLabel,
                        h;
                    ...
                    delete a.distributeBox }, this) }, y.pie.prototype.alignDataLabel =
            n, y.pie.prototype.verifyDataLabelOverflow = function(a) { var f = this.center,
                    h = this.options,
                    g = h.center,
                    d = h.minSize || 80,
                    m = null !== h.size; if (!m) { if (null !== g[0]) var n = Math.max(f[2] - Math.max(a[1], a[3]), d);
                    else n = Math.max(f[2] - a[1] - a[3], d), f[0] += (a[3] - a[1]) / 2;
                    null !== g[1] ? n = G(n, d, f[2] - Math.max(a[0], a[2])) : (n = G(n, d, f[2] - a[0] - a[2]), f[1] += (a[0] - a[2]) / 2);
                    n < f[2] ? (f[2] = n, f[3] = Math.min(t(h.innerSize || 0, n), n), this.translate(f), this.drawDataLabels && this.drawDataLabels()) : m = !0 } return m });
    ...
    O(n, "Extensions/OverlappingDataLabels.js", [n["Core/Chart/Chart.js"], n["Core/Utilities.js"]], function(f, a) {
        ...
        n(f, "render", function() {
            ...
            (this.series || []).forEach(function(f) { var n = f.options.dataLabels;
                f.visible && (!1 !== n.enabled || f._hasPointLabels) && (f.nodes || f.points).forEach(function(f) { f.visible && (D(f.dataLabels) ? f.dataLabels : f.dataLabel ? [f.dataLabel] : []).forEach(function(n) { var q = n.options;
        ...
        f.prototype.hideOverlappingLabels = function(a) {
            ...
            a.forEach(function(a) {
                if (a) {
                    var h =
                        a.newOpacity;
                    a.oldOpacity !== h && (a.alignAttr && a.placed ? (a[h ? "removeClass" : "addClass"]("highcharts-data-label-hidden"), t = !0, a.alignAttr.opacity = h, a[a.isOld ? "animate" : "attr"](a.alignAttr, null, function() { f.styledMode || a.css({ pointerEvents: h ? "auto" : "none" });
                        a.visibility = h ? "inherit" : "hidden" }), y(f, "afterHideOverlappingLabel")) : a.attr({ opacity: h }));
                    a.isOld = !0
                }
            });
    ...
    O(n, "Core/Interaction.js", [n["Core/Chart/Chart.js"], n["Core/Globals.js"], n["Core/Legend.js"], n["Core/Options.js"],
        ...
        var g = a.TrackerMixin = {
            drawTrackerPoint: function() {
                var a = this,
                    ...
                    k;
                a.points.forEach(function(a) { k = E(a.dataLabels) ? a.dataLabels : a.dataLabel ? [a.dataLabel] : [];
            ...
            drawTrackerGraph: function() {
                ...
                }), [a.tracker, a.markerGroup].forEach(function(a) { a.addClass("highcharts-tracker").on("mouseover", e).on("mouseout", function(a) { n.onTrackerMouseOut(a) });
                    f.cursor && !m.styledMode && a.css({ cursor: f.cursor }); if (l) a.on("touchstart", e) }));
                K(this, "afterDrawTracker")
            }
        };
        ...
        q(n.prototype, {
            setItemEvents: function(a, f, g) {
                ...
                (g ? [f, a.legendSymbol] : [a.legendGroup]).forEach(function(g) {
                    if (g) g.on("mouseover", function() { a.visible && d.allItems.forEach(function(d) { a !== d && d.setState("inactive", !k) });
                        a.setState("hover");
                        a.visible && h.addClass(l);
                        m || f.css(d.options.itemHoverStyle) }).on("mouseout", function() {
                        d.chart.styledMode || f.css(u(a.visible ?
                            d.itemStyle : d.itemHiddenStyle));
                        d.allItems.forEach(function(d) { a !== d && d.setState("", !k) });
                        h.removeClass(l);
                        a.setState()
                    }).on("click", function(e) { var c = function() { a.setVisible && a.setVisible();
                ...
                K(this, "pan", { originalEvent: d }, function() {
                    ...
                    f.forEach(function(e) {
                        ...
                        c.series.forEach(function(a) {
                            if (v &&
                                !e && (!x || x.isDirty)) { var b = a.getProcessedData(!0);
        ...
        q(D.prototype, {
            select: function(a, f) {
                ...
                d.firePointEvent(a ? "select" : "unselect", { accumulate: f }, function() {
                    ...
                    d.setState(a && "select");
                    f || k.getSelectedPoints().forEach(function(a) { var f = a.series;
            ...
            importEvents: function() { if (!this.hasImportedEvents) { var a = this,
                ...
                if (!(a === this.state && !f || this.selected && "select" !== a || !1 === k.enabled || a && (p || m && !1 === n.enabled) || a && c.states && c.states[a] && !1 === c.states[a].enabled)) {
                    ...
                    if (this.graphic) {
                        ...
                        a && this.graphic.addClass("highcharts-point-" +
                            a);
                        if (!b.styledMode) { var x = d.pointAttribs(this, a); var y = h(b.options.chart.animation, k.animation);
        ...
        q(y.prototype, {
            ...
            onMouseOut: function() { var a = this.options,
                    ...
                    g = f.tooltip,
                    h = f.hoverPoint;
                f.hoverSeries = null; if (h) h.onMouseOut();
                this && a.events.mouseOut && K(this, "mouseOut");!g || this.stickyTracking || g.shared && !this.noSharedTooltip || g.hide();
