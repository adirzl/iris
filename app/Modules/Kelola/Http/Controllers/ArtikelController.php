...
use Modules\Kelola\Http\Requests\ArtikelRequest;
use Carbon\Carbon;

class ArtikelController extends \App\Http\Controllers\Controller
{
    /**
    ...
    {
        $data = Artikel::fetch($request);
        return view('kelola::artikel.default', compact('data'));
    }
