...
class Regulasi extends \App\Entities\Model
{
    /**
     * @var string
     */
    protected $table = 'app_regulasi';

    /**
     * @var array
     */
    protected $fillable = [
        'title','description','file','image','created_at','updated_at','status',
    ];
    ...
    public function scopeFetch($query, $request, $export = false)
    {
        ...
        $q = $query->select(array_merge($this->fillable, ['id', 'title', 'description','file', 'image', 'created_at', 'updated_at','status']))
            ->orderBy('title');
