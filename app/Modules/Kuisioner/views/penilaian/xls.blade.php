@if($kuisioner->status_kuisioner == 1)
            ...
            <table class="table table-striped tablesaw" data-tablesaw-mode="stack">
                <tr>
                    <th colspan="5" style="text-align: center"><strong><h2>Kuisioner User Manrisk LJK Dan User Manrisk Bjb</h2></strong></th>
                </tr>
                
                <tr>
                    <th colspan="5" style="text-align: center"><strong><h2>Penerapan Manajemen Risiko di BPR</h2></strong></th>
                </tr>

                <tr>
                    <th colspan="5" style="text-align: center"><strong><h2>Divisi Manajemen Risiko</h2></strong></th>
                </tr>

                <tr>
                    <th colspan="1"><strong><h2>Periode</h2></strong></th>
                    <th colspan="4"><strong><h2>Triwulan {{$kuisioner->periode}} - Tahun {{$kuisioner->created_at->format('Y')}}</h2></strong></th>
                </tr>
                
                <tr>
                    <th colspan="1"><strong><h2>Nama Anak Perusahaan</h2></strong></th>
                    <th colspan="4"><strong><h2>{{$nama_perusahaan}}</h2></strong></th>
                </tr>
                ...
                <tr>
                    <th colspan="1"><strong><h2>Kategori</h2></strong></th>
                    <th colspan="4"><strong><h2>{{ $data->description }}</h2></strong></th>
                </tr>
                    <thead>
                    <tr>
        ...
        @else
            ...
            <table>
                    ...
                    <tr>
                        <th colspan="1"><strong><h2>Periode</h2></strong></th>
                        <th colspan="3"><strong><h2>Triwulan {{$kuisioner->periode}} - Tahun {{$kuisioner->created_at->format('Y')}}</h2></strong></th>
                    </tr>
                    
                    <tr>
                        <th colspan="1"><strong><h2>Nama Anak Perusahaan</h2></strong></th>
                        <th colspan="3"><strong><h2>{{$nama_perusahaan}}</h2></strong></th>
                    </tr>
                    ...
                    <tr>
                        <th colspan="1"><strong><h2>Pertanyaan</h2></strong></th>
                        <th colspan="3"><strong><h2>{{ $data->description }}</h2></strong></th>
                    </tr>
