...
if ($segment !== 'create' ) { $title = 'show'; $method = 'put'; $action = ['isikuisioner-manrisk.update', $isikuisioner->id]; }
@endphp
@extends('layouts.app')
        ...
        <table class="table table-striped tablesaw" data-tablesaw-mode="stack">
            <thead>
                <tr>
                    ...
                    <th>Penilaian</th>
                    <th style="width:5%">Bukti Implementasi</th>
                    <th>Keterangan</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="width:5%"><a href="{{ asset('penilaian_files/' . $v2->file) }}" target="_blank">{{ $v2->file }}</a></td>
