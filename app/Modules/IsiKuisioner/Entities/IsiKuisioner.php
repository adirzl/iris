...
class IsiKuisioner extends \App\Entities\Model
{
    /**
     * @var string
     */
    ...
    public function scopeFetch($query, $request, $export = false)
    {
        ...
        $q = $query->select(array_merge($this->fillable, ['id', 'user', 'created_at', 'updated_at', 'status_kuisioner', 'periode', 'status', 'modal_inti', 'nama_perusahaan']))
    ...
    {
        return $this->hasOne(Comprof::class, 'id', 'nama_perusahaan');
    }

    public function detail_penilaian()
    {
        return $this->hasMany(IsiKuisionerDetail::class, 'id_induk', 'id');
    }
}
