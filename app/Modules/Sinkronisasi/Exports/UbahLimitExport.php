...
class UbahLimitExport implements FromView, ShouldAutoSize, WithEvents
{
    use Exportable;
    ...
    {
        $data = \Modules\Sinkronisasi\Entities\UbahLimit::fetch($this->_request, true);

        return view('sinkronisasi::ubah-limit.xls', compact('data'));
    }
