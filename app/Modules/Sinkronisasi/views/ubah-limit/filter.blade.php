{{ Form::open(['url' => '/sinkronisasi-limit/filter', 'method' => 'post', 'class' => 'form-horizontal form-filter', 'role' => 'form', 'autocomplete' => 'off']) }}
    <div class="card card-teal collapsed-card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    {{ Form::fgText('Tgl. Sinkronisasi', 'tanggal', request()->tanggal ?? now()->yesterday()->format('Y-m-d'), ['class' => 'form-control datepick']) }}
                </div>
            </div>
        </div>
