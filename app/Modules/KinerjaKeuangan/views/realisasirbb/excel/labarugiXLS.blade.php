<table>
    ...
    <tr style="font-weight: bold; text-align: center">
        ...
        <td align="right">@if(is_null($last)) - @else @currency($pendops_realisasi_last) @endif</td>
        <td align="right">@currency($pendops_realisasi)</td>
        <td align="right">@currency($pendops_realisasi_target)</td>
        @if($p_pendops < 0) <td align="right">(@currency($p_pendops))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->bunga_kredit)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->bunga_kredit * 1000000) @endif</td>
        @if($p_bungakredit < 0) <td align="right">(@currency($p_bungakredit))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->bunga_ppbl)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->bunga_ppbl * 1000000) @endif</td>
        @if($p_bungappbl < 0) <td align="right">(@currency($p_bungappbl))</td>
        @else
    ...
    <tr style=" text-align: center">
        ...
        <td align="right">@currency($now->pend_provisi)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->pendapatan_provinsi * 1000000) @endif</td>
        @if($p_pendprov < 0) <td align="right">(@currency($p_pendprov))</td>
        @else
    ...
    <tr style=" text-align: center">
        ...
        <td align="right">@currency($now->pend_lainya)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->pendapatan_lainnya * 1000000) @endif</td>
        @if($p_pendlainya < 0) <td align="right">(@currency($p_pendlainya))</td>
        @else
    ...
    <tr style="font-weight: bold; text-align: center">
        ...
        <td align="right">@if(is_null($last)) - @else @currency($bebanops_realisasi_last) @endif</td>
        <td align="right">@currency($bebanops_realisasi)</td>
        <td align="right">@currency($bebanops_realisasi_target)</td>
        @if($p_bebanops < 0) <td align="right">(@currency($p_bebanops))</td>
        @else
    ...
    <tr style="font-weight: bold; text-align: center">
        ...
        <td align="right">@if(is_null($last)) - @else @currency($bunga_realisasi_last) @endif</td>
        <td align="right">@currency($bunga_realisasi)</td>
        <td align="right">@currency($bunga_realisasi_target)</td>
        @if($p_bunga < 0) <td align="right">(@currency($p_bunga))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        @if($p_tabungan < 0) <td align="right">(@currency($p_tabungan))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        @if($p_deposito < 0) <td align="right">(@currency($p_deposito))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->pin_diterima)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->pinjaman_diterima * 1000000) @endif</td>
        @if($p_pin_diterima < 0) <td align="right">(@currency($p_pin_diterima))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->peny_kerugian)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->penyisihan_kerugian * 1000000) @endif</td>
        @if($p_peny_kerugian < 0) <td align="right">(@currency($p_peny_kerugian))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->peny_ATI)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->penyusutan_ati * 1000000) @endif</td>
        @if($p_peny_ATI < 0) <td align="right">(@currency($p_peny_ATI))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->tenaga_kerja)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->tenaga_kerja * 1000000) @endif</td>
        @if($p_tenaga_kerja < 0) <td align="right">(@currency($p_tenaga_kerja))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->pendidikan)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->pendidikan * 1000000) @endif</td>
        @if($p_pendidikan < 0) <td align="right">(@currency($p_pendidikan))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->premi_asuransi)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->premi_asuransi * 1000000) @endif</td>
        @if($p_premi_asuransi < 0) <td align="right">(@currency($p_premi_asuransi))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->sewa)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->sewa * 1000000) @endif</td>
        @if($p_sewa < 0) <td align="right">(@currency($p_sewa))</td>
        @else
    ...
    <tr style="text-align: center">
        <td style="text-align: left">Pemeliharaan dan Perbaikan</td>
        <td align="right">@if(is_null($last)) - @else @currency($last->pemeliharaan_perbaikan) @endif</td>
        <td align="right">@currency($now->pemeliharaan_perbaikan)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->pemeliharaan_perbaikan * 1000000) @endif</td>
        @if($p_pemeliharaan_perbaikan < 0) <td align="right">(@currency($p_pemeliharaan_perbaikan))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->barangjasa)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->barang_dan_jasa * 1000000) @endif</td>
        @if($p_barangjasa < 0) <td align="right">(@currency($p_barangjasa))</td>
        @else
    ...
    <tr style="text-align: center">
        ...
        <td align="right">@currency($now->bebanlainya)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->beban_lainnya * 1000000) @endif</td>
        @if($p_bebanlainya < 0) <td align="right">(@currency($p_bebanlainya))</td>
        @else
    ...
    <tr style="font-weight: bold; text-align: center">
        ...
        <td align="right">@currency($now->labarugi)</td>
        <td align="right">@if(is_null($target)) - @else @currency($target->laba_rugi * 1000000) @endif</td>
        @if($p_labarugi < 0) <td align="right">(@currency($p_labarugi))</td>
        @else
