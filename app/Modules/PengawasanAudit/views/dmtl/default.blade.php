@extends('layouts.app')
@section('title', 'DMTL - Audit')
@section('content')
    @include('PengawasanAudit::dmtl.filter')
    @if(count($data))
    ...
    @else
        <div class="alert alert-warning">
            {!! trans('label.no_data_with_link', ['label' => 'DMTL - Audit', 'uri' => route('dmtl-audit.create')]) !!}
        </div>
    @endif
@endsection