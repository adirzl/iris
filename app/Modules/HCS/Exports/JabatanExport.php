...
class JabatanExport implements FromView, ShouldAutoSize, WithEvents
{
    use Exportable;
    ...
    {
        $data = \Modules\HCS\Entities\Jabatan::fetch($this->_request, true);

        return view('hcs::jabatan.xls', compact('data'));
    }
