...
class UnitKerjaExport implements FromView, ShouldAutoSize, WithEvents
{
    use Exportable;
    ...
    {
        $data = \Modules\HCS\Entities\UnitKerja::fetch($this->_request, true);

        return view('hcs::unit-kerja.xls', compact('data'));
    }
